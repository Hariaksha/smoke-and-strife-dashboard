"""Brazil wind fetch: one CDS request per YEAR (not per month), mirroring
nigeria/wind.py exactly - see that module's docstring for why year-batching
matters for a multi-year fetch.
"""
import tempfile
