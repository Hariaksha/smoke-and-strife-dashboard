"""Nigeria ACLED fetch + crosswalk + event-type aggregation, factored out
of build_panel.py/event_types.py so pipeline_bootstrap.py and
pipeline_update.py share one implementation instead of a third copy.
"""
import difflib
import io
